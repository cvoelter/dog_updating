...
# cup.is.edge =
#   (test.data$Number_arms == 8 &
#      (test.data$cup.id == 1 | test.data$cup.id == 5)) |
#   (test.data$Number_boxes == 4 &
#      (test.data$cup.id == 2 | test.data$cup.id == 5)) |
#   (test.data$Number_boxes == 5 &
#      (test.data$cup.id == 2 | test.data$cup.id == 6))
